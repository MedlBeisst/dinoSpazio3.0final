...
public class Nivel3 implements Screen
{
    ...
    public Nivel3(Plataforma plataforma) {
    ...
    private void cargarRecursos() {
        ...
        assetManager.load("mapaNivel3.tmx", TiledMap.class);  // Cargar info del mapa    nivel 1
    ...
    private void crearObjetos() {
        ...
        mapa = assetManager.get("mapaNivel3.tmx"); //nivel 1
    ...
    public void render(float delta) { // delta es el tiempo entre frames (Gdx.graphics.getDeltaTime())
        ...
        // ¿Ya ganó?
        if (estadoJuego==EstadosJuego.GANO || pizzaBuena>=72) {
        ...
        public boolean touchDown(int screenX, int screenY, int pointer, int button) {
            ...
            if (estadoJuego == EstadosJuego.PAUSADO) {
                ...
                if (btnGana.contiene(x, y)) {
                    ...
                    plataforma.setScreen(new PantallaCargando4(plataforma,4));
