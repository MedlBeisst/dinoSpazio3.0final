...
public class PantallaCargando2 implements Screen
{
    ...
    public PantallaCargando2(Plataforma plataforma, int nivel) {
    ...
    public void show() {
        ...
        texturaPantallaCargando=assetManager.get("level2.png");
    ...
    private void cargarRecursos() {
        ...
        assetManager.load("mapaNivel2.tmx", TiledMap.class);  // Cargar info del mapa
