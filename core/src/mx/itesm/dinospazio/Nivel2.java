...
public class Nivel2 implements Screen
{
    ...
    public Nivel2(Plataforma plataforma) {
    ...
    private void cargarRecursos() {
        ...
        assetManager.load("mapaNivel2.tmx", TiledMap.class);  // Cargar info del mapa    nivel 1
    ...
    private void crearObjetos() {
        ...
        mapa = assetManager.get("mapaNivel2.tmx"); //nivel 1
        ...
        public boolean touchDown(int screenX, int screenY, int pointer, int button) {
            ...
            if (estadoJuego == EstadosJuego.PAUSADO) {
                ...
                if (btnGana.contiene(x, y)) {
                    ...
                    plataforma.setScreen(new PantallaCargando3(plataforma,3));
